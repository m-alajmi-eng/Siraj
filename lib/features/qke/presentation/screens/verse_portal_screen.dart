    ...
    return SingleChildScrollView(
      ...
      child: Column(
        ...
        children: [
          ...
          if (muyassar != null) ...[
            const SizedBox(height: 16),
            _SourceBadge('التفسير الميسّر', palette),
          ],
        ],
      ),
    );
        ...
        children: [
          ...
          ...tafsirs.map((t) => Container(
            ...
            child: Column(
              ...
              children: [
                _SourceBadge(
                  t.scholar.isNotEmpty ? t.scholar : t.bookTitle,
                  palette,
                ),
