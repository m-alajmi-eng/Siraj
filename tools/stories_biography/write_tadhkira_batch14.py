#!/usr/bin/env python3
"""كتابة الدفعة الرابعة عشرة (10 أسماء، الطبقة العشرون) من تذكرة الحفاظ للذهبي عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/batch14_tadhkira"
AUTHOR = "الذهبي"
SOURCE_BOOK = "تذكرة الحفاظ"
SRC_URL = "https://ar.wikisource.org/wiki/" + urllib.parse.quote("تذكرة الحفاظ/الطبقة العشرون".replace(" ", "_"))

entries = [
    ("00_ابن العمادية.txt", None),
    ("01_ابن الساعي.txt", None),
    ("02_النواوي.txt", None),
    ("03_المحب.txt", "محب الدين الطبري"),
    ("04_الأبيوردي.txt", None),
    ("05_الإسعردي.txt", None),
    ("06_الدمياطي.txt", None),
    ("07_ابن الظاهري.txt", None),
    ("08_ابن دقيق العيد.txt", None),
    ("09_ابن الزبير.txt", None),
]
