#!/usr/bin/env python3
"""كتابة الدفعة التاسعة عشرة من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/ea146cfc-9eff-42e4-8dd6-150828943957/scratchpad/lisan_mizan/batch19"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ahmad_muhammad_yamami_hanafi.txt", "أحمد بن محمد بن عمر بن يونس الحنفي (أبو سهل اليمامي)"),
    ("ibrahim_jurayj_ruhawi.txt", "إبراهيم بن جريج الرهاوي"),
    ("ibrahim_abi_layth.txt", "إبراهيم بن أبي الليث"),
    ("ibrahim_hammad_zuhri_darir.txt", "إبراهيم بن حماد الزهري الضرير"),
    ("ibrahim_uqba.txt", "إبراهيم بن عقبة"),
    ("ibrahim_abdulwahid_baladi.txt", "إبراهيم بن عبد الواحد البلدي"),
]
