#!/usr/bin/env python3
"""كتابة الدفعة الخامسة عشرة (5 أسماء، سنوات 451-465هـ) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch15"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_الشرمقاني.txt", "أبو علي الشرمقاني", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة إحدى وخمسين وأربعمائة"),
    ("01_ابن حزم.txt", "ابن حزم الظاهري", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة ست وخمسين وأربعمائة"),
    ("02_أبو يعلى بن الفراء.txt", "أبو يعلى بن الفراء", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة ثمان وخمسين وأربعمائة"),
    ("03_الشيخ الأجل.txt", "عبد الملك بن محمد الشيخ الأجل", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة ستين وأربعمائة"),
    ("04_القشيري.txt", "أبو القاسم القشيري", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة خمس وستين وأربعمائة"),
]
