#!/usr/bin/env python3
"""كتابة الدفعة الرابعة والعشرين من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/ea146cfc-9eff-42e4-8dd6-150828943957/scratchpad/lisan_mizan/batch24"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ahmad_said_fardakh_ahmimi.txt", "أحمد بن سعيد بن فرضخ الأحميمي المصري"),
    ("ahmad_muhammad_dawud_sanani.txt", "أحمد بن محمد بن داود الصنعاني"),
    ("ahmad_muhammad_harb_mulhimi.txt", "أحمد بن محمد بن حرب الملحمي الجرجاني"),
    ("ismail_dawud_mikhraq.txt", "إسماعيل بن داود بن مخراق"),
    ("ibrahim_alaa_abi_harun_ghanawi.txt", "إبراهيم بن العلاء أبو هارون الغنوي"),
    ("ahmad_abdullah_shii.txt", "أحمد بن عبد الله الشيعي البغدادي"),
]
