#!/usr/bin/env python3
"""كتابة الدفعة التاسعة من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/ea146cfc-9eff-42e4-8dd6-150828943957/scratchpad/lisan_mizan/batch9"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ismail_qais_ansari.txt", "إسماعيل بن قيس بن سعد بن زيد بن ثابت الأنصاري أبو مصعب"),
    ("ibrahim_hisham_ghassani.txt", "إبراهيم بن هشام بن يحيى بن يحيى الغساني"),
    ("ahmad_abdulwahid_saadi.txt", "أحمد بن عبد الواحد بن مري السعدي المقدسي (تقي الدين الحوراني)"),
    ("ismail_muhammad_jibrini.txt", "إسماعيل بن محمد بن يوسف أبو هارون الجبريني"),
    ("ismail_ali_asterabadi.txt", "إسماعيل بن علي بن المثنى الأسترابادي الواعظ"),
    ("aslam_kufi.txt", "أسلم الكوفي"),
]
