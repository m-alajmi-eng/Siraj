#!/usr/bin/env python3
"""كتابة الدفعة الثامنة (3 أسماء، سنوات 354-368هـ) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch8"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_الطبراني.txt", "أبو القاسم الطبراني", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة ستين وثلاثمائة"),
    ("01_ابن عدي.txt", "أبو أحمد بن عدي", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة خمس وستين وثلاثمائة"),
    ("02_القاضي منذر البلوطي.txt", "القاضي منذر البلوطي", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة ست وستين وثلاثمائة"),
]
