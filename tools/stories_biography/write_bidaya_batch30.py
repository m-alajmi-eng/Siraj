#!/usr/bin/env python3
"""كتابة الدفعة الثلاثين (ثمانية أسماء، سنوات 679-697هـ، إتمام الجزء 13) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch30"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_ابن_خلكان.txt", "ابن خلكان صاحب وفيات الأعيان", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة إحدى وثمانين وستمائة"),
    ("01_البيضاوي.txt", "البيضاوي صاحب التصانيف", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة خمس وثمانين وستمائة"),
    ("02_قاضي_القضاة_ابن_الخويي.txt", "قاضي القضاة شهاب الدين ابن الخويي", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة ثلاث وتسعين وستمائة"),
    ("03_الشيخ_تقي_الدين_الواسطي.txt", "الشيخ تقي الدين الواسطي", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة ثنتين وتسعين وستمائة"),
    ("04_شرف_الدين_المقدسي.txt", "شرف الدين المقدسي", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة أربع وتسعين وستمائة"),
    ("05_الفاروثي.txt", "الفاروثي عز الدين", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة أربع وتسعين وستمائة"),
    ("06_زين_الدين_بن_منجى.txt", "زين الدين بن منجى", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة خمس وتسعين وستمائة"),
    ("07_تاج_الدين_الفزاري.txt", "تاج الدين الفزاري", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة تسع وثمانين وستمائة"),
]
