#!/usr/bin/env python3
"""كتابة الدفعة الثانية من لسان الميزان لابن حجر العسقلاني (6 أسماء، أعلام فكرية/أدبية إضافية
من الجزء الأول) عبر upsert_story_draft بمفتاح anon. is_published=false."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/a69de163-8c92-4c1e-a5b0-6caf4012500a/scratchpad/lisan_mizan/final2"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("nazzam.txt", "إبراهيم النظام"),
    ("abu_zayd_balkhi.txt", "أبو زيد البلخي"),
    ("niftawayh.txt", "نفطويه النحوي"),
    ("ibn_qasi.txt", "أحمد بن قسي"),
    ("bazzi.txt", "أحمد بن أبي بزة البزي المقرئ"),
    ("abu_mutarrif_balansi.txt", "أبو المطرف البلنسي"),
]
