#!/usr/bin/env python3
"""كتابة الدفعة الخامسة عشرة من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/ea146cfc-9eff-42e4-8dd6-150828943957/scratchpad/lisan_mizan/batch15"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ahmad_asad_safir.txt", "أحمد بن أسعد بن صفير (أبو الخليل)"),
    ("ibrahim_abdullah_saadi_nisaburi.txt", "إبراهيم بن عبد الله السعدي النيسابوري"),
    ("ibrahim_yazid_taathi.txt", "إبراهيم بن يزيد أبو خزيمة التاثي"),
    ("ahmad_shayban_ramli.txt", "أحمد بن شيبان الرملي"),
    ("ahmad_ali_ghaznawi.txt", "أحمد بن علي الغزنوي"),
    ("ismail_ibrahim_abu_ahwas.txt", "إسماعيل بن إبراهيم أبو الأحوص"),
]
