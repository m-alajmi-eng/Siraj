#!/usr/bin/env python3
"""كتابة الدفعة الخامسة من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/a69de163-8c92-4c1e-a5b0-6caf4012500a/scratchpad/lisan_mizan/final6"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ahmad_hammani.txt", "أحمد بن محمد بن الصلت الحماني"),
    ("ahmad_dawud_harrani.txt", "أحمد بن داود أبو صالح الحراني"),
    ("ishaq_bishr_abu_hudhayfa.txt", "إسحاق بن بشر أبو حذيفة البخاري"),
    ("ahmad_azhar_sijistani.txt", "أحمد بن محمد بن الأزهر السجستاني"),
    ("ahmad_ibn_rushdin.txt", "أحمد بن محمد بن رشدين"),
    ("asbagh_ibn_khalil.txt", "أصبغ بن خليل القرطبي"),
]
