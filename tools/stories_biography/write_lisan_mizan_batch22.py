#!/usr/bin/env python3
"""كتابة الدفعة الثانية والعشرين من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/ea146cfc-9eff-42e4-8dd6-150828943957/scratchpad/lisan_mizan/batch22"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ahmad_bahzad_sirafi.txt", "أحمد بن بهزاد بن مهران السيرافي"),
    ("ahmad_kamil_shajara_qadi.txt", "أحمد بن كامل بن شجرة القاضي البغدادي"),
    ("ibrahim_bitar_khwarizmi.txt", "إبراهيم بن بيطار الخوارزمي القاضي"),
    ("ahmad_said_himsi_khaishana.txt", "أحمد بن سعيد بن خيشنة الحمصي"),
    ("ismail_hamid_qusi.txt", "إسماعيل بن حامد القوصي"),
    ("ibrahim_abi_hayya_yasa.txt", "إبراهيم بن أبي حية اليسع بن الأشعث"),
]
