#!/usr/bin/env python3
"""كتابة الدفعة الثامنة والعشرين (سبعة أسماء، سنوات 649-663هـ، الجزء 13) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch28"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_مجد_الدين_بن_تيمية.txt", "مجد الدين ابن تيمية صاحب الأحكام", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة اثنين وخمسين وستمائة"),
    ("01_سبط_ابن_الجوزي.txt", "سبط ابن الجوزي صاحب مرآة الزمان", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة أربع وخمسين وستمائة"),
    ("02_الصرصري_المادح.txt", "الصرصري المادح", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة ست وخمسين وستمائة"),
    ("03_القرطبي_صاحب_المفهم.txt", "القرطبي صاحب المفهم في شرح مسلم", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة ست وخمسين وستمائة"),
    ("04_عز_الدين_بن_عبد_السلام.txt", "عز الدين بن عبد السلام سلطان العلماء", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة ستين وستمائة"),
    ("05_كمال_الدين_بن_العديم.txt", "كمال الدين بن العديم", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة ستين وستمائة"),
    ("06_الشيخ_القباري_الإسكندراني.txt", "الشيخ القباري الإسكندراني", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة ثنتين وستين وستمائة"),
]
