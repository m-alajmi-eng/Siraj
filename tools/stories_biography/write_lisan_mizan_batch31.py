#!/usr/bin/env python3
"""كتابة الدفعة الحادية والثلاثين (الأخيرة من الجزء الأول) من لسان الميزان لابن حجر العسقلاني
(6 أسماء) عبر upsert_story_draft بمفتاح anon. is_published=false."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/ea146cfc-9eff-42e4-8dd6-150828943957/scratchpad/lisan_mizan/batch31"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ibrahim_abdullah_hammam_sanani.txt", "إبراهيم بن عبد الله بن همام الصنعاني"),
    ("ahmad_muhammad_sakan_hafiz.txt", "أحمد بن محمد بن السكن الحافظ"),
    ("asbahdust_muhammad_shair.txt", "أصبهدوست بن محمد الديلمي أبو منصور الشاعر"),
    ("ahmad_hasan_qasim_kufi.txt", "أحمد بن الحسن بن القاسم بن سمرة الكوفي"),
    ("ahmad_imran_akhnasi.txt", "أحمد بن عمران الأخنسي"),
    ("ahmad_maytham_kufi.txt", "أحمد بن ميثم بن أبي نعيم الكوفي"),
]
