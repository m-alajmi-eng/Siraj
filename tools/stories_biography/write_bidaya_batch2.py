#!/usr/bin/env python3
"""كتابة الدفعة الثانية (5 أسماء، سنوات 264-278هـ) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch2"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_داود الظاهري.txt", "داود بن علي الظاهري", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة سبعين ومائتين"),
    ("01_ابن قتيبة الدينوري.txt", "ابن قتيبة الدينوري", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة سبعين ومائتين"),
    ("02_أبو داود السجستاني.txt", "أبو داود السجستاني", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة خمس وسبعين ومائتين"),
    ("03_بقي بن مخلد.txt", "بقي بن مخلد", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة ست وسبعين ومائتين"),
    ("04_أحمد بن عيسى الخراز.txt", "أحمد بن عيسى الخراز", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة سبع وسبعين ومائتين"),
]
