#!/usr/bin/env python3
"""كتابة الدفعة السابعة من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/a69de163-8c92-4c1e-a5b0-6caf4012500a/scratchpad/lisan_mizan/final8"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("aban_ibn_sufyan.txt", "أبان بن سفيان المقدسي"),
    ("asad_ibn_amr.txt", "أسد بن عمرو البجلي"),
    ("ibrahim_fadl_asbahani_bar.txt", "إبراهيم بن الفضل الأصبهاني (البار)"),
    ("ibrahim_zakariya_wasiti.txt", "إبراهيم بن زكريا الواسطي"),
    ("ibrahim_atiyya_thaqafi.txt", "إبراهيم بن عطية الثقفي"),
    ("ibrahim_fahd_hakim.txt", "إبراهيم بن فهد بن حكيم"),
]
