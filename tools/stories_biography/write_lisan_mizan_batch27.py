#!/usr/bin/env python3
"""كتابة الدفعة السابعة والعشرين من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/ea146cfc-9eff-42e4-8dd6-150828943957/scratchpad/lisan_mizan/batch27"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("aban_jafar_basri.txt", "أبان بن جعفر أبو سعيد البصري"),
    ("ishaq_ibrahim_israili_basri.txt", "إسحاق بن إبراهيم الإسرائيلي البصري"),
    ("azhar_abdullah_khurasani.txt", "أزهر بن عبد الله الخراساني"),
    ("ayyub_hasan_abi_rafi.txt", "أيوب بن حسن بن علي بن أبي رافع"),
    ("ahmad_isa_mahan_razi_jawwal.txt", "أحمد بن عيسى بن علي بن ماهان أبو جعفر الرازي (الجوال)"),
    ("ahmad_hafs_saadi_jurjani.txt", "أحمد بن حفص السعدي الجرجاني"),
]
