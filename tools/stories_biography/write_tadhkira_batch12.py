#!/usr/bin/env python3
"""كتابة الدفعة الثانية عشرة (24 اسماً، الطبقة الثامنة عشرة) من تذكرة الحفاظ للذهبي عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/batch12_tadhkira"
AUTHOR = "الذهبي"
SOURCE_BOOK = "تذكرة الحفاظ"
SRC_URL = "https://ar.wikisource.org/wiki/" + urllib.parse.quote("تذكرة الحفاظ/الطبقة الثامنة عشرة".replace(" ", "_"))

entries = [
    ("00_ابن القرطبي.txt", None),
    ("01_ابن حوط الله.txt", None),
    ("02_ابن الأثير.txt", None),
    ("03_العز.txt", "محمد بن عبد الغني المقدسي"),
    ("04_الملاحي.txt", None),
    ("05_ابن الأنماطي.txt", "إسماعيل بن عبد الله الأنماطي"),
    ("06_الضياء.txt", "الضياء المقدسي"),
    ("07_ابن القطان.txt", "ابن القطان الفاسي"),
    ("08_أبو موسى.txt", "عبد الله بن عبد الغني المقدسي"),
    ("09_ابن خليل.txt", None),
    ("10_ابن نقطة.txt", None),
    ("11_الدبيثي.txt", None),
    ("12_الكلاعي.txt", None),
    ("13_ابن دحية الكلبي.txt", None),
    ("14_البرزالي.txt", None),
    ("15_ابن الرومية.txt", None),
    ("16_ابن الطيلسان.txt", None),
    ("17_ابن النجار.txt", None),
    ("18_ابن الصلاح.txt", None),
    ("19_الصريفيني.txt", None),
    ("20_المنذري.txt", None),
    ("21_اليونيني.txt", None),
    ("22_الرشيد.txt", None),
    ("23_البكري.txt", None),
]
