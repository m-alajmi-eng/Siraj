#!/usr/bin/env python3
"""كتابة الدفعة السادسة عشرة (3 أسماء، سنوات 466-480هـ) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch16"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_الشريف أبو جعفر الحنبلي.txt", "الشريف أبو جعفر الحنبلي", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة سبعين وأربعمائة"),
    ("01_أبو إسحاق الشيرازي.txt", "أبو إسحاق الشيرازي", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة ست وسبعين وأربعمائة"),
    ("02_إمام الحرمين الجويني.txt", "إمام الحرمين الجويني", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة ثمان وسبعين وأربعمائة"),
]
