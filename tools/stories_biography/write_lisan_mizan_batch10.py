#!/usr/bin/env python3
"""كتابة الدفعة العاشرة من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/ea146cfc-9eff-42e4-8dd6-150828943957/scratchpad/lisan_mizan/batch10"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ismail_hammad_kufi.txt", "إسماعيل بن حماد بن أبي حنيفة الكوفي"),
    ("ashraf_ibn_aghar.txt", "الأشرف بن الأغر بن هاشم العلوي النسابة (تاج العلاء)"),
    ("ahmad_abdulrahman_saqati.txt", "أحمد بن عبد الرحمن السقطي"),
    ("ismail_amr_bajali.txt", "إسماعيل بن عمرو بن نجيح البجلي"),
    ("ibrahim_ishaq_hanzala.txt", "إبراهيم بن إسحاق بن إبراهيم (من ولد حنظلة الغسيل)"),
    ("ahmad_faraj_himsi.txt", "أحمد بن الفرج أبو عتبة الحمصي (الحجازي)"),
]
