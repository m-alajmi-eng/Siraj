#!/usr/bin/env python3
"""كتابة الدفعة الخامسة والعشرين (سبعة أسماء، سنوات 604-618هـ، الجزء 13) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch25"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_ابن_الأثير_مجد_الدين.txt", "ابن الأثير مجد الدين صاحب جامع الأصول", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة ست وستمائة"),
    ("01_فخر_الدين_الرازي.txt", "فخر الدين الرازي", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة ست وستمائة"),
    ("02_أبو_عمر_المقدسي.txt", "أبو عمر المقدسي", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة سبع وستمائة"),
    ("03_الشيخ_العماد_المقدسي.txt", "الشيخ العماد المقدسي", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة أربع عشرة وستمائة"),
    ("04_أبو_البقاء_العكبري.txt", "أبو البقاء العكبري", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة ست عشرة وستمائة"),
    ("05_ابن_شاس_الجذامي.txt", "ابن شاس الجذامي صاحب الجواهر", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة ست عشرة وستمائة"),
    ("06_الشيخ_عبد_الله_اليونيني.txt", "الشيخ عبد الله اليونيني", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة سبع عشرة وستمائة"),
]
