#!/usr/bin/env python3
"""كتابة الدفعة التاسعة والعشرين (ثلاثة أسماء، سنوات 664-678هـ، الجزء 13) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch29"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_الشيخ_علي_البكاء.txt", "الشيخ علي البكاء", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة سبعين وستمائة من الهجرة"),
    ("01_ابن_مالك_صاحب_الألفية.txt", "ابن مالك صاحب الألفية", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة اثنتين وسبعين وستمائة"),
    ("02_الإمام_النووي.txt", "الإمام النووي محيي الدين", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة ست وسبعين وستمائة"),
]
