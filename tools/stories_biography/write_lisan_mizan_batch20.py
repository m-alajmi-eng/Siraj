#!/usr/bin/env python3
"""كتابة الدفعة العشرين من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/ea146cfc-9eff-42e4-8dd6-150828943957/scratchpad/lisan_mizan/batch20"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ahmad_abi_sulayman_qawariri.txt", "أحمد بن أبي سليمان القواريري"),
    ("ahmad_marwan_dinawari.txt", "أحمد بن مروان الدينوري المالكي (صاحب المجالسة)"),
    ("akhnas_ibn_khalifa.txt", "أخنس بن خليفة"),
    ("ibrahim_zayd_aslami_taflisi.txt", "إبراهيم بن زيد الأسلمي التفليسي"),
    ("ishaq_nasih.txt", "إسحاق بن ناصح الجوهري"),
    ("ashras_abi_hasan_zayyat.txt", "أشرس بن أبي الحسن الزيات"),
]
