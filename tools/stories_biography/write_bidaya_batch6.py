#!/usr/bin/env python3
"""كتابة الدفعة السادسة (6 أسماء، سنوات 324-334هـ) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch6"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_أبو الحسن الأشعري.txt", "أبو الحسن الأشعري", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة أربع وعشرين وثلاثمائة"),
    ("01_أبو محمد البربهاري.txt", "أبو محمد البربهاري", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة تسع وعشرين وثلاثمائة"),
    ("02_المحاملي.txt", "الحسين بن إسماعيل المحاملي", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة ثلاثين وثلاثمائة"),
    ("03_أبو صالح مفلح الحنبلي.txt", "أبو صالح مفلح الحنبلي", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة ثلاثين وثلاثمائة"),
    ("04_الخرقي.txt", "عمر بن الحسين الخرقي", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة أربع وثلاثين وثلاثمائة"),
    ("05_أبو بكر الشبلي.txt", "أبو بكر الشبلي", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة أربع وثلاثين وثلاثمائة"),
]
