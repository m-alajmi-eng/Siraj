#!/usr/bin/env python3
"""كتابة الدفعة الرابعة والثلاثين (ستة أسماء، سنوات 733-764هـ) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon - آخر دفعة من الجزء 14 وآخر دفعة من المشروع بأكمله."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/a69de163-8c92-4c1e-a5b0-6caf4012500a/scratchpad/bidaya14/final34"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("733_2.txt", "بدر الدين بن جماعة قاضي القضاة", "البداية والنهاية/الجزء الرابع عشر/ثم دخلت سنة ثلاث وثلاثين وسبعمائة"),
    ("734_14.txt", "فتح الدين بن سيد الناس", "البداية والنهاية/الجزء الرابع عشر/ثم دخلت سنة أربع وثلاثين وسبعمائة"),
    ("738_8.txt", "ركن الدين بن القويع", "البداية والنهاية/الجزء الرابع عشر/ثم دخلت سنة ثمان وثلاثين وسبعمائة"),
    ("739_1.txt", "جلال الدين القزويني الشافعي", "البداية والنهاية/الجزء الرابع عشر/ثم دخلت سنة تسع وثلاثين وسبعمائة"),
    ("751_0.txt", "ابن قيم الجوزية", "البداية والنهاية/الجزء الرابع عشر/ثم دخلت سنة إحدى وخمسين وسبعمائة"),
    ("764_safadi.txt", "صلاح الدين خليل بن أيبك الصفدي", "البداية والنهاية/الجزء الرابع عشر/ثم دخلت سنة أربع وستين وسبعمائة"),
]
