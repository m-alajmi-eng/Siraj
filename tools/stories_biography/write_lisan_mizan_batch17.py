#!/usr/bin/env python3
"""كتابة الدفعة السابعة عشرة من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/ea146cfc-9eff-42e4-8dd6-150828943957/scratchpad/lisan_mizan/batch17"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ahmad_yaqub_umawi_jurjani.txt", "أحمد بن يعقوب الأموي المرواني الجرجاني"),
    ("aghlab_ibn_tamim.txt", "أغلب بن تميم الكندي"),
    ("ahmad_hasan_ibn_khayrun.txt", "أحمد بن الحسن بن خيرون"),
    ("ahmad_yusuf_manbiji.txt", "أحمد بن يوسف المنبجي"),
    ("ishaq_saad_kab_ujra.txt", "إسحاق بن سعد بن كعب بن عجرة الأنصاري"),
    ("ibrahim_muhammad_thaqafi_rafid.txt", "إبراهيم بن محمد بن سعيد الثقفي (مؤرخ الشيعة)"),
]
