#!/usr/bin/env python3
"""كتابة الدفعة السادسة من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/a69de163-8c92-4c1e-a5b0-6caf4012500a/scratchpad/lisan_mizan/final7"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ibrahim_amidi_khawwas.txt", "إبراهيم بن محمد الآمدي الخواص"),
    ("ibrahim_ghassani_sanhuri.txt", "إبراهيم بن خلف الغساني السنهوري"),
    ("ghulam_khalil.txt", "أحمد بن محمد بن غالب (غلام خليل)"),
    ("ibrahim_ibn_rustam.txt", "إبراهيم بن رستم"),
    ("ahmad_jaybari.txt", "أحمد بن عبد الله الجويباري"),
    ("ibrahim_ibn_bara.txt", "إبراهيم بن البراء بن النضر"),
]
