#!/usr/bin/env python3
"""كتابة الدفعة الرابعة والعشرين (اسمان، سنوات 589-603هـ، أول دفعة من الجزء 13) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch24"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_ابن الشاطبي.txt", "الشاطبي صاحب الشاطبية", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة تسعين وخمسمائة"),
    ("01_ابن الزكي.txt", "القاضي ابن الزكي", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة ثمان وتسعين وخمسمائة"),
]
