#!/usr/bin/env python3
"""كتابة الدفعة الثالثة والثلاثين (ستة أسماء، سنوات 723-730هـ) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/a69de163-8c92-4c1e-a5b0-6caf4012500a/scratchpad/bidaya14/final33"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("723_10.txt", "بهاء الدين بن عساكر الطبيب", "البداية والنهاية/الجزء الرابع عشر/ثم دخلت سنة ثلاث وعشرين وسبعمائة"),
    ("723_18.txt", "شرف الدين بن النجيح الحراني", "البداية والنهاية/الجزء الرابع عشر/ثم دخلت سنة ثلاث وعشرين وسبعمائة"),
    ("726_6.txt", "شمس الدين محمد بن مسلم الحنبلي", "البداية والنهاية/الجزء الرابع عشر/ثم دخلت سنة ست وعشرين وسبعمائة"),
    ("727_7.txt", "كمال الدين بن الزملكاني", "البداية والنهاية/الجزء الرابع عشر/ثم دخلت سنة سبع وعشرين وسبعمائة"),
    ("729_6.txt", "برهان الدين الفزاري (ابن تاج الدين)", "البداية والنهاية/الجزء الرابع عشر/ثم دخلت سنة تسع وعشرين وسبعمائة"),
    ("730_4.txt", "أحمد الحجار (ابن الشحنة)", "البداية والنهاية/الجزء الرابع عشر/ثم دخلت سنة ثلاثون وسبعمائة"),
]
