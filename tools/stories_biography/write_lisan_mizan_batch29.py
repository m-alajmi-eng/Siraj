#!/usr/bin/env python3
"""كتابة الدفعة التاسعة والعشرين من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/ea146cfc-9eff-42e4-8dd6-150828943957/scratchpad/lisan_mizan/batch29"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ishaq_kamil_muaddib.txt", "إسحاق بن كامل المؤدب"),
    ("ibrahim_abi_thabit_zuhri.txt", "إبراهيم بن أبي ثابت (محمد بن عبد العزيز) الزهري المدني"),
    ("ahmad_zurara_madani.txt", "أحمد بن زرارة المدني"),
    ("ahmad_salim_asqalani_abu_tawba.txt", "أحمد بن سالم العسقلاني (أبو توبة)"),
    ("ahmad_salama_kufi_samari.txt", "أحمد بن سلمة الكوفي (السمري)"),
    ("ahmad_ali_husayn_madaini.txt", "أحمد بن علي بن الحسين المدائني"),
]
