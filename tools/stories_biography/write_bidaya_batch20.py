#!/usr/bin/env python3
"""كتابة الدفعة العشرين (اسمان، سنوات 526-540هـ) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch20"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("01_محمد بن عبد الباقي.txt", "محمد بن عبد الباقي الأنصاري", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة خمس وثلاثين وخمسمائة"),
    ("00_الزمخشري.txt", "الزمخشري", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة ثمان وثلاثين وخمسمائة"),
]
