#!/usr/bin/env python3
"""كتابة الدفعة السادسة والعشرين (ستة أسماء، سنوات 619-633هـ، الجزء 13) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch26"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_ابن_قدامة_الموفق.txt", "موفق الدين ابن قدامة صاحب المغني", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة عشرين وستمائة"),
    ("01_فخر_الدين_ابن_عساكر.txt", "فخر الدين ابن عساكر", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة عشرين وستمائة"),
    ("02_ابن_معطي_النحوي.txt", "ابن معطي النحوي صاحب الألفية", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة ثمان وعشرين وستمائة"),
    ("03_شهاب_الدين_السهروردي.txt", "شهاب الدين السهروردي صاحب عوارف المعارف", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة ثلاثين وستمائة"),
    ("04_سيف_الدين_الآمدي.txt", "سيف الدين الآمدي", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة إحدى وثلاثين وستمائة"),
    ("05_الشيخ_عبد_الله_الأرمني.txt", "الشيخ عبد الله الأرمني", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة إحدى وثلاثين وستمائة"),
]
