#!/usr/bin/env python3
"""كتابة الدفعة السادسة عشرة من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/ea146cfc-9eff-42e4-8dd6-150828943957/scratchpad/lisan_mizan/batch16"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ismail_abi_ziyad_shaqari.txt", "إسماعيل بن أبي زياد الشقري"),
    ("ismail_raja_hisni.txt", "إسماعيل بن رجاء الحصني"),
    ("ahmad_muhammad_musa_muhabbir.txt", "أحمد بن محمد بن موسى بن الصلت المحبر"),
    ("ayyub_salih_harrani.txt", "أيوب بن صالح الحراني المخزومي"),
    ("ahmad_bundunayji.txt", "أحمد بن أحمد بن أحمد البندنيجي"),
    ("ibrahim_jarrah_qadi_misr.txt", "إبراهيم بن الجراح بن صبيح (قاضي مصر)"),
]
