#!/usr/bin/env python3
"""كتابة الدفعة الثالثة من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/a69de163-8c92-4c1e-a5b0-6caf4012500a/scratchpad/lisan_mizan/final4"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("dabbat_affan.txt", "إبراهيم بن ديزيل (دابة عفان)"),
    ("ibrahim_tinnin_abbasi.txt", "إبراهيم بن المهدي (ابن شكلة)"),
    ("ishaq_kahili.txt", "إسحاق بن بشر الكاهلي"),
    ("ismail_yahya_taymi.txt", "إسماعيل بن يحيى التيمي"),
    ("ahwas_ghallabi.txt", "الأحوص بن المفضل الغلابي"),
    ("ahmad_hasanuya.txt", "أحمد بن علي بن حسنويه"),
]
