#!/usr/bin/env python3
"""إضافة الاسمين المؤجَّلين من لسان الميزان (السيد الحميري، إسحاق النخعي الأحمر) بعد قرار محمد
النهائي الشامل: لا استبعاد تحريري لأي شخصية موثقة بمصدر معتبر بسبب عقيدتها أو أشعارها أو مواقفها.
نسخ حرفي كامل بلا حذف ولا تلطيف. is_published=false."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/a69de163-8c92-4c1e-a5b0-6caf4012500a/scratchpad/lisan_mizan/final3"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("sayyid_himyari.txt", "السيد الحميري"),
    ("ishaq_nakhai_ahmar.txt", "إسحاق بن محمد النخعي الأحمر"),
]
