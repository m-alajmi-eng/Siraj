#!/usr/bin/env python3
"""كتابة الدفعة السابعة (اسم واحد، سنوات 339-353هـ) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch7"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_أبو بكر الأدمي.txt", "محمد بن جعفر بن فضالة أبو بكر الأدمي", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة ثمان وأربعين وثلاثمائة"),
]
