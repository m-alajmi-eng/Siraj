#!/usr/bin/env python3
"""كتابة الدفعة الثالثة عشرة من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/ea146cfc-9eff-42e4-8dd6-150828943957/scratchpad/lisan_mizan/batch13"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ibrahim_bakr_shaybani.txt", "إبراهيم بن بكر الشيباني الأعور"),
    ("ahmad_abi_dawud_qadi.txt", "أحمد بن أبي داود القاضي"),
    ("ahmad_tayyib_sarakhsi.txt", "أحمد بن الطيب السرخسي (معلم المعتضد)"),
    ("ismail_shabib_taifi.txt", "إسماعيل بن شبيب الطائفي"),
    ("ibrahim_muhammad_ansari_mudda3i.txt", "إبراهيم بن محمد الأنصاري (أبو المعالي، مدَّعي نسب أبي أيوب)"),
    ("ahmad_muhammad_andarshi.txt", "أحمد بن محمد بن عبد الله الأنصاري (الأندرشي، ابن اليتيم)"),
]
