#!/usr/bin/env python3
"""كتابة الدفعة الرابعة (4 أسماء، سنوات 294-308هـ) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch4"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_الجنيد.txt", "الجنيد بن محمد", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة سبع وتسعين ومائتين"),
    ("01_محمد بن داود الظاهري.txt", "محمد بن داود الظاهري", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة سبع وتسعين ومائتين"),
    ("02_سعيد بن إسماعيل الواعظ.txt", "سعيد بن إسماعيل الواعظ", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة سبع وتسعين ومائتين"),
    ("03_يوسف بن الحسين الرازي.txt", "يوسف بن الحسين الرازي", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة أربع وثلاثمائة"),
]
