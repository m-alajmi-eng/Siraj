#!/usr/bin/env python3
"""كتابة الدفعة الثانية عشرة (4 أسماء، سنوات 406-420هـ، أول الجزء 12) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch12"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_أبو حامد الإسفرايني.txt", "أبو حامد الإسفرايني", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة ست وأربعمائة"),
    ("01_الكشغلي.txt", "الكشغلي", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة أربع عشرة وأربعمائة"),
    ("02_ابن أبي الشوارب.txt", "ابن أبي الشوارب", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة سبع عشرة وأربعمائة"),
    ("03_اللالكائي.txt", "أبو القاسم اللالكائي", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة ثمان عشرة وأربعمائة"),
]
