#!/usr/bin/env python3
"""كتابة الدفعة الثامنة والعشرين من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/ea146cfc-9eff-42e4-8dd6-150828943957/scratchpad/lisan_mizan/batch28"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ahmad_thabit_tarqi.txt", "أحمد بن ثابت الطرقي الحافظ"),
    ("ismail_marzuq_muradi_kabi.txt", "إسماعيل بن مرزوق المرادي الكعبي المصري"),
    ("ibrahim_yazid_ibn_qudayd.txt", "إبراهيم بن يزيد بن قديد (صاحب الأوزاعي)"),
    ("ishaq_harith_kufi.txt", "إسحاق بن الحارث الكوفي"),
    ("ahmad_tariq_karaki.txt", "أحمد بن طارق الكركي"),
    ("ahmad_tahir_harmala_tujibi.txt", "أحمد بن طاهر بن حرملة التجيبي المصري"),
]
