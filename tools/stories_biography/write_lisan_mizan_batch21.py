#!/usr/bin/env python3
"""كتابة الدفعة الحادية والعشرين من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/ea146cfc-9eff-42e4-8dd6-150828943957/scratchpad/lisan_mizan/batch21"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ibrahim_ishaq_nakhra_sanani.txt", "إبراهيم بن إسحاق بن نخرة الصنعاني"),
    ("ayyub_mudrik_hanafi.txt", "أيوب بن مدرك الحنفي"),
    ("ahmad_ibrahim_abi_sukayna_halabi.txt", "أحمد بن إبراهيم بن أبي سكينة الحلبي"),
    ("ahmad_abdullah_maysara_nahawandi.txt", "أحمد بن عبد الله بن ميسرة (أبو ميسرة النهاوندي الحراني)"),
    ("ahmad_ubaydullah_ibn_kadish.txt", "أحمد بن عبيد الله أبو العز بن كادش"),
    ("ishaq_abi_yahya_kabi.txt", "إسحاق بن أبي يحيى الكعبي"),
]
