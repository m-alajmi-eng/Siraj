#!/usr/bin/env python3
"""كتابة الدفعة الرابعة من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/a69de163-8c92-4c1e-a5b0-6caf4012500a/scratchpad/lisan_mizan/final5"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ishaq_dabari.txt", "إسحاق بن إبراهيم الدبري"),
    ("ibrahim_ibn_ulayya_jahmi.txt", "إبراهيم بن إسماعيل بن علية"),
    ("ahmad_hasan_sufi.txt", "أحمد بن الحسن الصوفي"),
    ("ahmad_kindi_sufi.txt", "أحمد بن عيسى الكندي الصوفي"),
    ("ibn_dost_allaf.txt", "أحمد بن محمد بن دوست العلاف"),
    ("ibrahim_ibn_hudba.txt", "إبراهيم بن هدبة"),
]
