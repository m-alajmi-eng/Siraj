#!/usr/bin/env python3
"""كتابة الدفعة السادسة والعشرين من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/ea146cfc-9eff-42e4-8dd6-150828943957/scratchpad/lisan_mizan/batch26"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ibrahim_muawiya_ziyadi.txt", "إبراهيم بن معاوية الزيادي"),
    ("ahmad_isa_tanisi_khashshab.txt", "أحمد بن عيسى التنيسي الخشاب"),
    ("ismail_yala_abi_umayya_thaqafi.txt", "إسماعيل بن يعلى أبو أمية الثقفي البصري"),
    ("ibrahim_muhammad_maymun_shii.txt", "إبراهيم بن محمد بن ميمون (من أجلاد الشيعة)"),
    ("ahmad_nasr_dhari.txt", "أحمد بن نصر الذارع"),
    ("asram_ghiyath_khurasani.txt", "أصرم بن غياث الخراساني النيسابوري"),
]
