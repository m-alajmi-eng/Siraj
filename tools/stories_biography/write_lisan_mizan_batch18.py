#!/usr/bin/env python3
"""كتابة الدفعة الثامنة عشرة من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/ea146cfc-9eff-42e4-8dd6-150828943957/scratchpad/lisan_mizan/batch18"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ibrahim_haytham_baladi.txt", "إبراهيم بن هيثم البلدي"),
    ("ahmad_hasan_misri_amuli.txt", "أحمد بن الحسن بن أبان المصري الآملي"),
    ("ahmad_muhammad_batlahi.txt", "أحمد بن محمد بن يحيى بن حمزة البتلهي الدمشقي"),
    ("ahmad_hilal_hassani_sufi.txt", "أحمد بن هلال الحساني الصوفي (زنديق حلب)"),
    ("artah_ashath.txt", "أرطاة بن أشعث"),
    ("ibrahim_miqsam_asadi.txt", "إبراهيم بن مقسم الأسدي (والد إسماعيل بن علية)"),
]
