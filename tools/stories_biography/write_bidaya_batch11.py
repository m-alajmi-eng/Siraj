#!/usr/bin/env python3
"""كتابة الدفعة الحادية عشرة (اسمان، سنوات 399-405هـ، آخر صفحات الجزء 11) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch11"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_الباقلاني.txt", "أبو بكر الباقلاني", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة ثلاث وأربعمائة"),
    ("01_الحاكم النيسابوري.txt", "الحاكم النيسابوري", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة خمس وأربعمائة"),
]
