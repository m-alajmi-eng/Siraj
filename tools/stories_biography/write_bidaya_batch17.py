#!/usr/bin/env python3
"""كتابة الدفعة السابعة عشرة (اسمان، سنوات 481-495هـ) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch17"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_أبو بكر الشاشي.txt", "أبو بكر الشاشي", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة ثمان وثمانين وأربعمائة"),
    ("01_عبد الباقي البراعي.txt", "عبد الباقي البراعي", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة ثنتين وتسعين وأربعمائة"),
]
