#!/usr/bin/env python3
"""كتابة الدفعة الثانية والعشرين (اسم واحد، سنوات 556-570هـ) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch22"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_عبد القادر الجيلي.txt", "الشيخ عبد القادر الجيلي", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة إحدى وستين وخمسمائة"),
]
