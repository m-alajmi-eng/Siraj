#!/usr/bin/env python3
"""كتابة الدفعة السابعة والعشرين (ثلاثة أسماء، سنوات 634-648هـ، الجزء 13) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch27"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_محيي_الدين_بن_عربي.txt", "محيي الدين ابن عربي", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة ثمان وثلاثين وستمائة"),
    ("01_علم_الدين_السخاوي.txt", "علم الدين السخاوي", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة ثلاث وأربعين وستمائة"),
    ("02_أبو_عمرو_بن_الحاجب.txt", "أبو عمرو بن الحاجب المالكي", "البداية والنهاية/الجزء الثالث عشر/ثم دخلت سنة ست وأربعين وستمائة"),
]
