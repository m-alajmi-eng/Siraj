#!/usr/bin/env python3
"""كتابة الدفعة الثالثة عشرة (3 أسماء، سنوات 421-435هـ) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch13"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_عبد الوهاب صاحب التلقين.txt", "عبد الوهاب بن علي البغدادي", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة اثنتين وعشرين وأربعمائة"),
    ("01_أبو نعيم الأصبهاني.txt", "أبو نعيم الأصبهاني", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة إحدى وثلاثين وأربعمائة"),
    ("02_أبو زيد الدبوسي.txt", "أبو زيد الدبوسي", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة إحدى وثلاثين وأربعمائة"),
]
