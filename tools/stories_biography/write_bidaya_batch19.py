#!/usr/bin/env python3
"""كتابة الدفعة التاسعة عشرة (اسمان، سنوات 511-525هـ) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch19"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_ابن عقيل.txt", "أبو الوفا ابن عقيل", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة ثلاث عشرة وخمسمائة"),
    ("01_البغوي.txt", "البغوي المفسر", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة ست عشرة وخمسمائة"),
]
