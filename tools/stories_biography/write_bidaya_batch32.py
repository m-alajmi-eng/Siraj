#!/usr/bin/env python3
"""كتابة الدفعة الثانية والثلاثين (ستة أسماء، سنوات 716-723هـ) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/a69de163-8c92-4c1e-a5b0-6caf4012500a/scratchpad/bidaya14/final32"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("716_10.txt", "صدر الدين ابن الوكيل", "البداية والنهاية/الجزء الرابع عشر/ثم دخلت سنة ست عشرة وسبعمائة"),
    ("718_0.txt", "محمد بن قوام البالسي", "البداية والنهاية/الجزء الرابع عشر/ثم دخلت سنة ثمان عشرة وسبعمائة"),
    ("718_1.txt", "تقي الدين عبد الله بن تمام", "البداية والنهاية/الجزء الرابع عشر/ثم دخلت سنة ثمان عشرة وسبعمائة"),
    ("718_5.txt", "كمال الدين ابن الشريشي", "البداية والنهاية/الجزء الرابع عشر/ثم دخلت سنة ثمان عشرة وسبعمائة"),
    ("722_0.txt", "شمس الدين بن العز الحنفي", "البداية والنهاية/الجزء الرابع عشر/ثم دخلت سنة عشرين وسبعمائة"),
    ("723_1.txt", "قاضي القضاة نجم الدين بن صصرى", "البداية والنهاية/الجزء الرابع عشر/ثم دخلت سنة ثلاث وعشرين وسبعمائة"),
]
