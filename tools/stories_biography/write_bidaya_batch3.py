#!/usr/bin/env python3
"""كتابة الدفعة الثالثة (4 أسماء، سنوات 279-293هـ) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch3"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_البلاذري.txt", "البلاذري", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة مائتين وإحدى وسبعين"),
    ("01_إبراهيم الحربي.txt", "إبراهيم الحربي", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة خمس وثمانين ومائتين"),
    ("02_عبدالله بن الإمام أحمد.txt", "عبد الله بن الإمام أحمد بن حنبل", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة تسعين ومائتين"),
    ("03_الكجي.txt", "الكجي", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة ثلاث وتسعين ومائتين"),
]
