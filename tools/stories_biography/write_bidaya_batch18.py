#!/usr/bin/env python3
"""كتابة الدفعة الثامنة عشرة (4 أسماء، سنوات 496-510هـ) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch18"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_جعفر السراج.txt", "جعفر بن محمد السراج", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة خمسمائة من الهجرة"),
    ("01_الروياني.txt", "أبو المحاسن الروياني", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة ثنتين وخمسمائة"),
    ("02_الكيا الهراسي.txt", "الكيا الهراسي", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة أربع وخمسمائة"),
    ("03_أبو حامد الغزالي.txt", "أبو حامد الغزالي", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة خمس وخمسمائة"),
]
