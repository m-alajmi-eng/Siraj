#!/usr/bin/env python3
"""كتابة الدفعة الحادية عشرة (24 اسماً، الطبقة السابعة عشرة) من تذكرة الحفاظ للذهبي عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/batch11_tadhkira"
AUTHOR = "الذهبي"
SOURCE_BOOK = "تذكرة الحفاظ"
SRC_URL = "https://ar.wikisource.org/wiki/" + urllib.parse.quote("تذكرة الحفاظ/الطبقة السابعة عشرة".replace(" ", "_"))

entries = [
    ("00_ابن بشكوال.txt", None),
    ("01_ابن الجوزي.txt", None),
    ("02_السهيلي.txt", None),
    ("03_عبد الحق بن عبد الرحمن بن عبد الله .txt", "عبد الحق الإشبيلي"),
    ("04_ابن حبيش.txt", None),
    ("05_ابن الفخار.txt", None),
    ("06_الشيرازي.txt", "يوسف بن أحمد الشيرازي"),
    ("07_أبو المواهب.txt", "أبو المواهب بن صصرى"),
    ("08_الزيدي.txt", None),
    ("09_الحازمي.txt", None),
    ("10_أبو المحاسن القرشي.txt", None),
    ("11_أبو عمر بن عياد يوسف بن عبد الله بن.txt", "أبو عمر بن عياد"),
    ("12_القاسم.txt", "القاسم بن علي بن عساكر"),
    ("13_ابن عبيد الله.txt", "عبد الله بن محمد الحجري"),
    ("14_عبد الغني بن عبد الواحد.txt", "عبد الغني المقدسي"),
    ("14b_الباقداري.txt", None),
    ("15_ابن الحضري.txt", None),
    ("16_ابن الأخضر.txt", None),
    ("17_عبد الرزاق.txt", "عبد الرزاق بن عبد القادر الجيلاني"),
    ("18_عبد القادر بن عبد الله.txt", "عبد القادر الرهاوي"),
    ("19_ابن عات.txt", None),
    ("20_علي الإسكندراني.txt", None),
    ("21_ربيعة بن الحسن بن علي.txt", None),
    ("22_التجيبي.txt", None),
]
