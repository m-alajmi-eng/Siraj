#!/usr/bin/env python3
"""كتابة الدفعة الرابعة عشرة من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/ea146cfc-9eff-42e4-8dd6-150828943957/scratchpad/lisan_mizan/batch14"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("asad_abi_rawh_rafidi.txt", "أسعد بن أبي روح أبو الفضل الرافضي (قاضي طرابلس)"),
    ("aban_uthman_ahmar.txt", "أبان بن عثمان الأحمر"),
    ("ahmad_bakr_balisi.txt", "أحمد بن بكر البالسي (ابن بكرويه)"),
    ("ismail_ali_khuzai.txt", "إسماعيل بن علي الخزاعي"),
    ("ahmad_ali_tarithithi.txt", "أحمد بن علي بن زكريا الطريثيثي"),
    ("ibrahim_harasa_shaybani.txt", "إبراهيم بن هراسة الشيباني الكوفي"),
]
