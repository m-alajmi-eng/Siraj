#!/usr/bin/env python3
"""كتابة الدفعة الخامسة عشرة (7 أسماء، الطبقة الحادية والعشرون - الأخيرة) من تذكرة الحفاظ للذهبي عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/batch15_tadhkira"
AUTHOR = "الذهبي"
SOURCE_BOOK = "تذكرة الحفاظ"
SRC_URL = "https://ar.wikisource.org/wiki/" + urllib.parse.quote("تذكرة الحفاظ/الطبقة الحادية والعشرون".replace(" ", "_"))

entries = [
    ("00_ابن فرح.txt", None),
    ("01_علي بن عبد الكافي.txt", None),
    ("02_ابن جعوان.txt", None),
    ("03_ابن الفوطي.txt", None),
    ("04_الحارثي.txt", None),
    ("05_ابن تيمية.txt", None),
    ("06_المزي.txt", None),
]
