#!/usr/bin/env python3
"""كتابة الدفعة الثامنة من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/ea146cfc-9eff-42e4-8dd6-150828943957/scratchpad/lisan_mizan/batch8"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ishaq_ibrahim_tabari.txt", "إسحاق بن إبراهيم الطبري"),
    ("ibrahim_abdullah_khalid.txt", "إبراهيم بن عبد الله بن خالد"),
    ("ayyub_khaut.txt", "أيوب بن خوط أبو أمية البصري"),
    ("asram_hawshab.txt", "أصرم بن حوشب أبو هشام (قاضي همدان)"),
    ("ahmad_jafar_qatii.txt", "أحمد بن جعفر بن حمدان القطيعي"),
    ("ishaq_wahb_tahramisi.txt", "إسحاق بن وهب الطهرمسي"),
]
