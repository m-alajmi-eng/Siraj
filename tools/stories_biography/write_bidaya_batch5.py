#!/usr/bin/env python3
"""كتابة الدفعة الخامسة (5 أسماء، سنوات 309-323هـ) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch5"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_بنان الحمال.txt", "بنان الحمال", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة ست عشرة وثلاثمائة"),
    ("01_الطحاوي.txt", "الطحاوي", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة إحدى وعشرين وثلاثمائة"),
    ("02_أبو عمر القاضي المالكي.txt", "أبو عمر القاضي المالكي", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة عشرين وثلاثمائة"),
    ("03_أبو علي الروذباري.txt", "أبو علي الروذباري", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة اثنتين وعشرين وثلاثمائة"),
    ("04_أحمد بن إسحاق التنوخي.txt", "أحمد بن إسحاق التنوخي", "البداية والنهاية/الجزء الحادي عشر/ثم دخلت سنة تسع عشرة وثلاثمائة"),
]
