#!/usr/bin/env python3
"""كتابة الدفعة الحادية عشرة من لسان الميزان لابن حجر العسقلاني (6 أسماء من الجزء الأول)
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/ea146cfc-9eff-42e4-8dd6-150828943957/scratchpad/lisan_mizan/batch11"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("ayyub_sayyar_zuhri.txt", "أيوب بن سيار الزهري المدني"),
    ("ahmad_muhammad_marwazi.txt", "أحمد بن محمد بن عمرو المروزي الفقيه"),
    ("ismail_abdullah_ruayni.txt", "إسماعيل بن عبد الله الرعيني (الأندلسي)"),
    ("ibrahim_zakariya_ijli.txt", "إبراهيم بن زكريا العجلي البصري"),
    ("ashath_ibn_barraz.txt", "أشعث بن براز الهجيمي"),
    ("ayyub_muhammad_ajli_yamami.txt", "أيوب بن محمد أبو سهل العجلي اليمامي"),
]
