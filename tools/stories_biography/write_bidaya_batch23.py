#!/usr/bin/env python3
"""كتابة الدفعة الثالثة والعشرين (اسمان، سنوات 571-588هـ - آخر دفعة من الجزء 12) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch23"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_أحمد الرفاعي.txt", "الشيخ أحمد الرفاعي", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة ثمان وسبعين وخمسمائة"),
    ("01_ابن أبي عصرون.txt", "ابن أبي عصرون", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة خمس وثمانين وخمسمائة"),
]
