#!/usr/bin/env python3
"""كتابة الدفعة الثالثة عشرة (11 اسماً، الطبقة التاسعة عشرة) من تذكرة الحفاظ للذهبي عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/batch13_tadhkira"
AUTHOR = "الذهبي"
SOURCE_BOOK = "تذكرة الحفاظ"
SRC_URL = "https://ar.wikisource.org/wiki/" + urllib.parse.quote("تذكرة الحفاظ/الطبقة التاسعة عشرة".replace(" ", "_"))

entries = [
    ("00_أحمد بن عيسى.txt", None),
    ("01_خالد بن يوسف بن سعد بن حسن بن مفرج.txt", None),
    ("02_ابن مسدي.txt", None),
    ("03_ابن سيد الناس.txt", "محمد بن أحمد بن سيد الناس"),
    ("04_الرسعني.txt", None),
    ("05_ابن الحاجب.txt", None),
    ("06_الرُّعَيْني.txt", None),
    ("07_ابن الكماد.txt", None),
    ("08_أبو شامة.txt", None),
    ("09_النابلسي.txt", "يوسف بن الحسن النابلسي"),
    ("10_ابن الصابوني.txt", None),
]
