#!/usr/bin/env python3
"""كتابة الدفعة الرابعة عشرة (4 أسماء، سنوات 436-450هـ) من البداية والنهاية لابن كثير عبر upsert_story_draft بمفتاح anon."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/5b3301c6-b957-4875-a5a0-f28d2e514459/scratchpad/bidaya_wa_nihaya/batch14"
AUTHOR = "ابن كثير"
SOURCE_BOOK = "البداية والنهاية"

entries = [
    ("00_أبو محمد الجويني.txt", "أبو محمد الجويني", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة ثمان وثلاثين وأربعمائة"),
    ("01_أبو عبد الله الصوري.txt", "أبو عبد الله الصوري", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة إحدى وأربعين وأربعمائة"),
    ("02_أبو عثمان الصابوني.txt", "أبو عثمان الصابوني", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة تسع وأربعين وأربعمائة"),
    ("03_أبو الطيب الطبري.txt", "أبو الطيب الطبري", "البداية والنهاية/الجزء الثاني عشر/ثم دخلت سنة خمسين وأربعمائة"),
]
