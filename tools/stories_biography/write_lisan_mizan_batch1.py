#!/usr/bin/env python3
"""كتابة الدفعة الأولى من مصدر جديد: لسان الميزان لابن حجر العسقلاني (8 أسماء، أعلام أدبية/فكرية
من الجزء الأول) عبر upsert_story_draft بمفتاح anon. is_published=false افتراضياً (بلا نشر تلقائي)."""
...
SCRATCH = "/tmp/claude-1000/-home-user-projects-siraj/a69de163-8c92-4c1e-a5b0-6caf4012500a/scratchpad/lisan_mizan/final1"
AUTHOR = "ابن حجر العسقلاني"
SOURCE_BOOK = "لسان الميزان"
PAGE_TITLE = "لسان الميزان/الجزء الأول"

entries = [
    ("maarri.txt", "أبو العلاء المعري"),
    ("mutanabbi.txt", "أبو الطيب المتنبي"),
    ("abu_atahiya.txt", "أبو العتاهية"),
    ("ishaq_mawsili.txt", "إسحاق الموصلي"),
    ("jawhari.txt", "الجوهري صاحب الصحاح"),
    ("ashab.txt", "أشعب الطامع"),
    ("sahib_ibn_abbad.txt", "الصاحب بن عباد"),
    ("ahmad_ghazali.txt", "أحمد الغزالي (أبو الفتوح الطوسي)"),
]
